...
while true; do wget -q -O- http://<LBDNSNAME>; done

kubectl rollout history deployment.v1beta1.apps/myacart-frontend -n mycart

docker run -d --name cart-fe-test -p 9001:80 -v cart-fe-test-logs:/var/log -v /home/ubuntu:/home/ubuntu mohanraz81/cart-fe:2.0
docker run -d --name cart-fe-logs -v cart-fe-test-logs:/mnt/log:ro mohanraz81/cart-felogs:1.0
...
docker build -t mohanraz81/cart-felogs:1.0 cart1410/myappfrontendlogs/
...
#
DocumentRoot "/apps/apache"

#
# Relax access to content within /apps.
#
<Directory "/apps">
    AllowOverride None
    # Allow open access:
...
#
# "/apps/cgi-bin" should be changed to whatever your ScriptAliased
